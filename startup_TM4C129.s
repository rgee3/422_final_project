...
SVC_Handler\    
                ...
                ; Load the address of _systemcall_table_jump into R0
                LDR     R0, =_systemcall_table_jump

                ; Branch to _systemcall_table_jump to handle the system call
                BX      R0
...
SysTick_Handler\
                ...
                ; Load the address of _timer_update into R0
                LDR     R0, =_timer_update

                ; Branch to _timer_update to handle the timer countdown
                BX      R0
